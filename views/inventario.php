                ...
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label class="text-primary" for="edit_producto"><i
                                    class="fa-solid fa-box me-2"></i>Producto</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="edit_precio" name="edit_precio" type="text"
                                placeholder="Precio">
                            <label class="text-primary" for="edit_precio"><i
                                    class="fa-solid fa-dollar-sign me-2"></i>Precio</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" id="edit_unidades" name="edit_unidades" type="text"
                                placeholder="Unidades">
                            <label class="text-primary" for="edit_unidades"><i
                                    class="fa-solid fa-cubes me-2"></i>Unidades</label>
                        </div>
                    </div>
                </div>
            </div>
